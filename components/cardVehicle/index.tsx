...
export default function CardVehicle({ idveiculo, modelo, observacao, valor, ano_fabricacao, ano_modelo, motor, quilometragem, combustivel }: Cars) {
    return <div key={idveiculo} className={'xl:h-160 not-xl:mt-5 rounded-lg bg-primary'}>
        ...
        <div className={'mt-5 px-3 text-offWhite '}>
            ...
            <div className='grid grid-cols-1 gap-5 md:gap-2 m-5 md:relative w-full overflow-hidden'>
                <p className='z-20 flex items-center gap-2 bg-primary w-fit '><Joystick />{motor ? motor : "?"}</p>
